...
// Frontend-only redirect delay after a successful submission (ms).
...
export default function Contact() {
  ...
  // Frontend-only submission: no backend call. We simulate a brief
  // processing beat, then show a themed success state and hand the
  // visitor off to the Services page automatically.
  const handleSubmit = () => {
    if (!validate()) return;
          ...
          <div className="contact-form">
            {status === 'success' ? (
              <div className="form-success" role="status" aria-live="polite">
                ...
                <p className="text-muted" style={{ fontSize: 'var(--fs-sm)', marginTop: '-1rem' }}>
                  Taking you to explore our services…
                </p>
